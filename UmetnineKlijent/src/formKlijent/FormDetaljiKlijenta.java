...
public class FormDetaljiKlijenta extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtBrojTelefona.setBackground(new java.awt.Color(149, 210, 236));

        txtJMBG.setBackground(new java.awt.Color(149, 210, 236));

        jLabel2.setText("Ime:");

        cmbStatus.setBackground(new java.awt.Color(149, 210, 236));
        cmbStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "STANDARD", "SILVER", "GOLD" }));

        txtIme.setEditable(false);
        txtIme.setBackground(new java.awt.Color(149, 210, 236));

        jLabel3.setText("Prezime:");

        txtPrezime.setBackground(new java.awt.Color(149, 210, 236));
    ...
    private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniActionPerformed
        ...
        try {
            ...
            fp.refreshTable();
            fp.popuniKlijente();
            JOptionPane.showMessageDialog(this, "Sistem je izmenio klijenta.");
            this.dispose();
        } catch (Exception ex) {
    ...
    private void btnObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObrisiActionPerformed
        ...
        if (result == JOptionPane.YES_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Sistem ne moze da obrise klijenta. (Klijent vec ima racun)");
